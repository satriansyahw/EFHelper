...
{
    public class RepoDeleteSave : InterfaceRepoDeleteSave
    {
        private EFReturnValue eFReturn = new EFReturnValue { IsSuccessConnection = false, IsSuccessQuery = false, ErrorMessage = ErrorMessage.EntityCannotBeNull, ReturnValue = null };
        private static RepoDeleteSave instance;
        public static RepoDeleteSave GetInstance
        {
            get
            {
                if (instance == null) instance = new RepoDeleteSave();
                return instance;
            }
        }
        public virtual EFReturnValue DeleteSave<TDelete, T1>(List<SearchField> deleteParameters, T1 entitySave1)
            where TDelete : class
            where T1 : class
        {
            int hasil = 0;
        ...
        public virtual EFReturnValue DeleteSave<TDelete, T1, T2>(List<SearchField> deleteParameters, T1 entitySave1, T2 entitySave2)
            where TDelete : class
            where T1 : class
            where T2 : class
        {
        ...
        public virtual EFReturnValue DeleteSave<TDelete, T1, T2, T3>(List<SearchField> deleteParameters, T1 entitySave1, T2 entitySave2, T3 entitySave3)
            where TDelete : class
            where T1 : class
            where T2 : class
            where T3 : class
        ...
        public virtual EFReturnValue DeleteSave<TDelete, T1, T2, T3, T4, T5>(List<SearchField> deleteParameters, T1 entitySave1, T2 entitySave2, T3 entitySave3, T4 entitySave4, T5 entitySave5)
            where TDelete : class
            where T1 : class
            where T2 : class
            where T3 : class
