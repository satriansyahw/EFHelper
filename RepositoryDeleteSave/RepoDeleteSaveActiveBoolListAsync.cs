...
{
    public class RepoDeleteSaveActiveBoolListAsync : InterfaceRepoDeleteSaveActiveBoolListAsync
    {
        private EFReturnValue eFReturn = new EFReturnValue { IsSuccessConnection = false, IsSuccessQuery = false, ErrorMessage = ErrorMessage.EntityCannotBeNull, ReturnValue = null };
        private static RepoDeleteSaveActiveBoolListAsync instance;
        public static RepoDeleteSaveActiveBoolListAsync GetInstance
        {
            get
            {
                if (instance == null) instance = new RepoDeleteSaveActiveBoolListAsync();
                return instance;
            }
        }
        public virtual async Task<EFReturnValue> DeleteSaveActiveBoolListAsync<TDelete, T1>(List<SearchField> deleteParameters, List<T1> listEntitySave1)
            where TDelete : class
            where T1 : class
        {
        ...
        public virtual async Task<EFReturnValue> DeleteSaveActiveBoolListAsync<TDelete, T1, T2>(List<SearchField> deleteParameters, List<T1> listEntitySave1, List<T2> listEntitySave2)
            where TDelete : class
            where T1 : class
            where T2 : class
        {
        ...
        public virtual async Task<EFReturnValue> DeleteSaveActiveBoolListAsync<TDelete, T1, T2, T3>(List<SearchField> deleteParameters, List<T1> listEntitySave1, List<T2> listEntitySave2, List<T3> listEntitySave3)
            where TDelete : class
            where T1 : class
            where T2 : class
            where T3 : class
        ...
        public virtual async Task<EFReturnValue> DeleteSaveActiveBoolListAsync<TDelete, T1, T2, T3, T4>(List<SearchField> deleteParameters, List<T1> listEntitySave1, List<T2> listEntitySave2, List<T3> listEntitySave3, List<T4> listEntitySave4)
            where TDelete : class
            where T1 : class
            where T2 : class
            where T3 : class
