...
using static EFHelper.MiscClass.EFReturnValue;

namespace EFHelper.RepositoryDeleteSave
{
    public class RepoDeleteSaveActiveBool : InterfaceRepoDeleteSaveActiveBool
    {
        private EFReturnValue eFReturn = new EFReturnValue { IsSuccessConnection = false, IsSuccessQuery = false, ErrorMessage = ErrorMessage.EntityCannotBeNull, ReturnValue = null };
        private static RepoDeleteSaveActiveBool instance;
        public static RepoDeleteSaveActiveBool GetInstance
        {
            get
            {
                if (instance == null) instance = new RepoDeleteSaveActiveBool();
                return instance;
            }
        }
        public virtual EFReturnValue DeleteSaveActiveBool<TDelete, T1>(List<SearchField> deleteParameters, T1 entitySave1)
            where TDelete : class
            where T1 : class
        {
                    ...
                    using (var contextTrans = context.Database.BeginTransaction())
                    {
                        try
                        {
                            ...
                            if (listDeleteRV.IsSuccessConnection & listDeleteRV.IsSuccessQuery)
                            {
                                ...
                                var x = ((List<DictReturnValue>)listDeleteRV.ReturnValue[0]);
        ...
        public virtual EFReturnValue DeleteSaveActiveBool<TDelete, T1, T2>(List<SearchField> deleteParameters, T1 entitySave1, T2 entitySave2)
            where TDelete : class
            where T1 : class
            where T2 : class
        {
        ...
        public virtual EFReturnValue DeleteSaveActiveBool<TDelete, T1, T2, T3>(List<SearchField> deleteParameters, T1 entitySave1, T2 entitySave2, T3 entitySave3)
            where TDelete : class
            where T1 : class
            where T2 : class
            where T3 : class
        ...
        public virtual EFReturnValue DeleteSaveActiveBool<TDelete, T1, T2, T3, T4>(List<SearchField> deleteParameters, T1 entitySave1, T2 entitySave2, T3 entitySave3, T4 entitySave4)
            where TDelete : class
            where T1 : class
            where T2 : class
            where T3 : class
        ...
        public virtual EFReturnValue DeleteSaveActiveBool<TDelete, T1, T2, T3, T4, T5>(List<SearchField> deleteParameters, T1 entitySave1, T2 entitySave2, T3 entitySave3, T4 entitySave4, T5 entitySave5)
            where TDelete : class
            where T1 : class
            where T2 : class
            where T3 : class
