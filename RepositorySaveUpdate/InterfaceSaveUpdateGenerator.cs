...
{
    public interface InterfaceSaveUpdate
    {
    ...
    public interface InterfaceSaveUpdateList
    {
    ...
    public interface InterfaceSaveUpdateAsync
    {
    ...
    public interface InterfaceSaveUpdateListAsync
    {
