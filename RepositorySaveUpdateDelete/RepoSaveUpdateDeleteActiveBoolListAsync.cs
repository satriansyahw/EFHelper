...
{
    public class RepoSaveUpdateDeleteActiveBoolListAsync : InterfaceRepoSaveUpdateDeleteActiveBoolListAsync
    {
        private EFReturnValue eFReturn = new EFReturnValue { IsSuccessConnection = false, IsSuccessQuery = false, ErrorMessage = ErrorMessage.EntityCannotBeNull, ReturnValue = null };
        private static RepoSaveUpdateDeleteActiveBoolListAsync instance;
        public static RepoSaveUpdateDeleteActiveBoolListAsync GetInstance
        {
            get
            {
                if (instance == null) instance = new RepoSaveUpdateDeleteActiveBoolListAsync();
                return instance;
            }
        }        
        ...
        public async Task<EFReturnValue> SaveUpdateDeleteActiveBoolListAsync<T1, T2>(List<T1> listEntity1, EnumSaveUpdateDelete enumSUDT1, List<T2> listEntity2, EnumSaveUpdateDelete enumSUDT2)
            where T1 : class
            where T2 : class
        {
            int hasil = 0; eFReturn = new EFReturnValue { IsSuccessConnection = false, IsSuccessQuery = false, ErrorMessage = ErrorMessage.EntityCannotBeNull, ReturnValue = null };
        ...
        public async Task<EFReturnValue> SaveUpdateDeleteActiveBoolListAsync<T1, T2, T3>(List<T1> listEntity1, EnumSaveUpdateDelete enumSUDT1, List<T2> listEntity2, EnumSaveUpdateDelete enumSUDT2, List<T3> listEntity3, EnumSaveUpdateDelete enumSUDT3)
            where T1 : class
            where T2 : class
            where T3 : class
        {
        ...
        public async Task<EFReturnValue> SaveUpdateDeleteActiveBoolListAsync<T1, T2, T3, T4>(List<T1> listEntity1, EnumSaveUpdateDelete enumSUDT1, List<T2> listEntity2, EnumSaveUpdateDelete enumSUDT2, List<T3> listEntity3, EnumSaveUpdateDelete enumSUDT3, List<T4> listEntity4, EnumSaveUpdateDelete enumSUDT4)
            where T1 : class
            where T2 : class
            where T3 : class
            where T4 : class
