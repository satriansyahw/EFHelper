...
{
    public class RepoSaveUpdateDeleteAsync : InterfaceRepoSaveUpdateDeleteAsync
    {
        private EFReturnValue eFReturn = new EFReturnValue { IsSuccessConnection = false, IsSuccessQuery = false, ErrorMessage = ErrorMessage.EntityCannotBeNull, ReturnValue = null };
        private static RepoSaveUpdateDeleteAsync instance;
        public static RepoSaveUpdateDeleteAsync GetInstance
        {
            get
            {
                if (instance == null) instance = new RepoSaveUpdateDeleteAsync();
                return instance;
            }
        }

        public async Task<EFReturnValue> SaveUpdateDeleteAsync<T1>(T1 entity1, EnumSaveUpdateDelete enumSUDT1) where T1 : class
        {
        ...
        public async Task<EFReturnValue> SaveUpdateDeleteAsync<T1, T2>(T1 entity1, EnumSaveUpdateDelete enumSUDT1, T2 entity2, EnumSaveUpdateDelete enumSUDT2)
            where T1 : class
            where T2 : class
        {
            int hasil = 0; eFReturn = new EFReturnValue { IsSuccessConnection = false, IsSuccessQuery = false, ErrorMessage = ErrorMessage.EntityCannotBeNull, ReturnValue = null };
        ...
        public async Task<EFReturnValue> SaveUpdateDeleteAsync<T1, T2, T3>(T1 entity1, EnumSaveUpdateDelete enumSUDT1, T2 entity2, EnumSaveUpdateDelete enumSUDT2, T3 entity3, EnumSaveUpdateDelete enumSUDT3)
            where T1 : class
            where T2 : class
            where T3 : class
        {
        ...
        public async Task<EFReturnValue> SaveUpdateDeleteAsync<T1, T2, T3, T4, T5>(T1 entity1, EnumSaveUpdateDelete enumSUDT1, T2 entity2, EnumSaveUpdateDelete enumSUDT2, T3 entity3, EnumSaveUpdateDelete enumSUDT3, T4 entity4, EnumSaveUpdateDelete enumSUDT4, T5 entity5, EnumSaveUpdateDelete enumSUDT5)
            where T1 : class
            where T2 : class
            where T3 : class
            where T4 : class
